...
<xsl:stylesheet version="1.0"	xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:WC="wgcontrols">
  ...
  <xsl:template match="WC:Tags.TextBox[not(@Attr.Multiline) and (@Attr.CustomStyle='TextBoxSkin')]" mode="modContent">
  ...
  <xsl:template match="WC:Tags.TextBox[@Attr.Multiline and (@Attr.CustomStyle='TextBoxSkin')]" mode="modContent">
